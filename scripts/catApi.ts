...
let favorites: { id: string, image_id: string,sub_id:string }[] = []; // array to store img id of favorites
...
export async function favourite(id: string, target: EventTarget) {  //YES I'm using cat API to store favorites for Rick and Morty :-) (Because I can!!!!)
